...
png("ALl_track.png", width = 10, height = 12, units = "in", res = 600)
...
png("All_tracks_v48.png", width = 10, height = 12, units = "in", res = 600)
plotTracks(
  list(  ATAC, H2A.Zac, H2A.Z, H2B.Z,H3K18ac,H3K27ac,H3K4me3,H3K9ac,
         H3,H3K18me, H3K27me, H3K36me3, H3K4me1, H3K4me2, H3K4me,H3R17me2,MNase, geneTrack),
  chromosome = chr, from = from, to = to,
  sizes = c( 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8,0.8, 0.8,0.8,0.2),      # relative heights
