...
"Toenhake_2018 <- make_bw_track(bw_file[1], chr, from, to,
                               ...
                               title_cex = 0.1, 
                               color = "#E69F00", 
                               label_cex = 0.5) # Optional: if you want to hide the title"

Ruiz_2018     <- make_bw_track(bw_file[2], chr, from, to,
                               name = " ", 
                               title_cex = 0.1, 
                               color = "skyblue", # or whatever color you used
                               label_cex = 0.5)
...
png("Ruiz_2018_ATAC_track.png", width = 10, height = 2, units = "in", res = 600)
plotTracks(list( Ruiz_2018), 
...
png("Ruiz_2018_ATAC_track_v48.png", width = 12, height = 1, units = "in", res = 600)
plotTracks(
  list(   Ruiz_2018, geneTrack),
  chromosome = chr, from = from, to = to,
